...
export const getStorageInfo = async (userId) => {
  try {
    ...
    // REMOVED: Firestore direct access
    ...
    console.warn('getStorageInfo: Firestore disabled, returning default values');

    // Return default values (same as when no storage document exists)
    return {
      storage_quota_mb: 0,
      used_storage_mb: 0,
      file_count: 0,
